...
var src_01_proto_hello_pb = require('../../../src/01/proto/hello_pb.js');

function serialize_hello_HelloRequest(arg) {
  if (!(arg instanceof src_01_proto_hello_pb.HelloRequest)) {
...
function deserialize_hello_HelloRequest(buffer_arg) {
  return src_01_proto_hello_pb.HelloRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_hello_HelloResponse(arg) {
  if (!(arg instanceof src_01_proto_hello_pb.HelloResponse)) {
...
function deserialize_hello_HelloResponse(buffer_arg) {
  return src_01_proto_hello_pb.HelloResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var HelloServiceService = exports.HelloServiceService = {
  hello: {
    ...
    requestType: src_01_proto_hello_pb.HelloRequest,
    responseType: src_01_proto_hello_pb.HelloResponse,
